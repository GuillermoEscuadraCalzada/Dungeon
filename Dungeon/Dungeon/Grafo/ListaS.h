...
/**
* Consigue el Nodo Especificado
*
* @param NodoT<T>* (El nodo que se está buscando)
* @return NodoT<T>* El nodo
*/
template <class T>
...
/**
* Consigue el index del Nodo Especificado
*
* @param NodoT<T>* (El nodo del que se está buscando el index)
* @return int (El index)
*/
template <class T>
...
/**
* Checa si hay un nodo especificado en la lista
*
* @param NodoT<T>* (El nodo del que se está buscando el index)
* @return bool (Si está o si no está)
*/
template <class T>
...
/**
* Consigue un elemto de la lista en un index específico
*
* @param int (El index del que se quiere conseguir el valor)
* @return T (El valor)
*/
template <class T>
...
*
* @param T* (El Nodo que se quiere eliminar)
* @return NULL
*/
template <class T>
